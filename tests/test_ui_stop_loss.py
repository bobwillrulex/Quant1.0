...
class StopLossUITests(unittest.TestCase):
    ...
    def test_stop_loss_dropdown_and_fixed_input_present(self):
        ...
        self.assertIn('option value="vwap_volume_first5_trend_momentum_5m"', html)
        self.assertIn('option value="vwap_volume_profile_first5_trend_momentum_5m"', html)
        self.assertIn('option value="vwap_volume_profile_value_area_5m"', html)
        self.assertIn('option value="vwap_volume_profile_value_area_15m"', html)
        ...
        self.assertIn("vwap_volume_first5_trend_momentum_5m: \"Built for 5m day trading using the first 5 bars", html)
        self.assertIn("vwap_volume_profile_first5_trend_momentum_5m: \"Built for 5m day trading using first-5-bar context", html)
        self.assertIn("vwap_volume_profile_value_area_5m: \"Built for intraday 5m execution", html)
        self.assertIn("vwap_volume_profile_value_area_15m: \"Built for intraday 15m context", html)
